...
})({"1J2BE":[function(require,module,exports) {
...
function getTopCourses(data, count) {
    return data.filter((item)=>item.type === "Kurs").sort((a, b)=>b.applicantsTotal - a.applicantsTotal).slice(0, count);
}
function getTopPrograms(data, count) {
    return data.filter((item)=>item.type === "Program").sort((a, b)=>b.applicantsTotal - a.applicantsTotal).slice(0, count);
}
...
},{"chart.js/auto":"cooxU","@parcel/transformer-js/src/esmodule-helpers.js":"j7FRh"}],"cooxU":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{"../dist/chart.js":"fiG5f","@parcel/transformer-js/src/esmodule-helpers.js":"j7FRh"}],"fiG5f":[function(require,module,exports) {
/*!
 * Chart.js v4.4.1
...
},{"./chunks/helpers.segment.js":"gcxQp","@kurkle/color":"lUkb7","@parcel/transformer-js/src/esmodule-helpers.js":"j7FRh"}],"gcxQp":[function(require,module,exports) {
/*!
 * Chart.js v4.4.1
 * https://www.chartjs.org
 * (c) 2023 Chart.js Contributors
...
},{"@kurkle/color":"lUkb7","@parcel/transformer-js/src/esmodule-helpers.js":"j7FRh"}],"lUkb7":[function(require,module,exports) {
/*!
 * @kurkle/color v0.3.2
