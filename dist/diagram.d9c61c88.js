...
function createBarChart(coursesData) {
    ...
    const series = [
        coursesData.map((course)=>parseInt(course.applicantsTotal))
    ];
    new _chartist.Bar(".ct-bar-chart", {
        labels: labels,
        series: series
    }, {
        axisY: {
...
function createPieChart(programsData) {
    ...
    new _chartist.Pie(".ct-pie-chart", {
        labels: labels,
        series: series
    });
}

},{"chartist":"cvvBN"}],"cvvBN":[function(require,module,exports) {
/**
