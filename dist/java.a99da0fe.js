...
function _fetchDataAndGenerateCharts() {
  _fetchDataAndGenerateCharts = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var response, data, coursesData, programsData;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return fetch('statistik_sokande.json');
        case 3:
        ...
        case 6:
          data = _context.sent;
          if (data) {
            coursesData = getTopCourses(data, 6);
            programsData = getTopPrograms(data, 5);
    ...
    data: {
      ...
      datasets: [{
        ...
        data: coursesData.map(function (course) {
          return parseInt(course.applicantsTotal);
        }),
    ...
    data: {
      ...
      datasets: [{
        data: programsData.map(function (program) {
          return parseInt(program.applicantsTotal);
        }),
