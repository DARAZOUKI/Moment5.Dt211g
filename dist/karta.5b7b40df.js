...
})({"1bcnk":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "42036d7a98ade5a7";
module.bundle.HMR_BUNDLE_ID = "0e0bb4c75b7b40df";
"use strict";
...
},{}],"hWb37":[function(require,module,exports) {
"use strict";
document.addEventListener("DOMContentLoaded", function() {
    ...
    locationInput.addEventListener("change", async function() {
        ...
        try {
            ...
            if (coordinates) displayMap(coordinates);
            else alert("Could not fetch coordinates. Please try again.");
        } catch (error) {
